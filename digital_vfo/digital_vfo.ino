...
// define pins we connect to the LCD
...
#define SELECT_CHAR     0   // shows 'underlined' decimal digits
...
void loop()
{
  ...
  if (old_freq != freq || old_position != copy_re_position)
  {
    print_freq(freq, copy_re_position);
    old_freq = freq;
    old_position = copy_re_position;
